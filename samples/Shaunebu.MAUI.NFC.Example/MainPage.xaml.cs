...
namespace Shaunebu.MAUI.NFC.Maui.Sample;
            ...
            switch (_type)
            {
                case NFCNdefTypeFormat.WellKnown:
                    record = new NFCNdefRecord
                    {
                        ...
                        MimeType = MIME_TYPE,
                        Payload = NFCUtils.EncodeToByteArray("Shaunebu.MAUI.NFC is awesome!"),
                        LanguageCode = "en"
                    };
                    break;
                case NFCNdefTypeFormat.Uri:
                    record = new NFCNdefRecord
                    {
                        ...
                        Payload = NFCUtils.EncodeToByteArray("https://github.com/franckbour/Shaunebu.MAUI.NFC")
                    };
                    break;
